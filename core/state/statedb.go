...
// StateDB structs within the olink protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/olink/go-olink/pull/16485#issuecomment-380438527),
