...
import (
	...
	"github.com/olink/go-olink/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors toolinker.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toolinker
				var orVector []byte
...
// the requested retrieval queue to be serviced toolinker with other sessions.
//
