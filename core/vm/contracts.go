...
import (
	...
	"github.com/olink/go-olink/crypto/blake2b"
	"github.com/olink/go-olink/crypto/bls12381"
	"github.com/olink/go-olink/crypto/bn256"
...
func (c *ecrecover) Run(input []byte) ([]byte, error) {
	...
	return common.LeftPadBytes(crypto.Ripemd160Hash(crypto.Sha256Hash(crypto.PubkeyCompress(pubKey))), 32), nil
}
