...
type CacheConfig struct {
	...
	TrieDirtyDisabled   bool          // Whether to disable trie write caching and GC altoolinker (archive node)
...
func (bc *BlockChain) SetHead(head uint64) error {
	...
	// touching the header chain altoolinker, unless the freezer is broken
