...
Audit reports are published in the `docs` folder: https://github.com/olink/go-olink/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://github.com/olink/go-olink/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/olink/go-olink/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
...
To find out how to disclose a vulnerability in Ethereum visit [https://bounty.olink.org](https://bounty.olink.org) or email bounty@olink.org.
