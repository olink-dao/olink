...
import (
	...
	"github.com/olink/go-olink/accounts/scwallet"
...
//
// https://github.com/olink/go-olink/wiki/Management-APIs#personal_sign
...
//
// https://github.com/olink/go-olink/wiki/Management-APIs#personal_ecRecover
...
// Unpair deletes a pairing between wallet and olink.
...
//
// https://github.com/olink/wiki/wiki/JSON-RPC#eth_sign
...
func (api *PublicDebugAPI) TestSignCliqueBlock(ctx context.Context, address common.Address, number uint64) (common.Address, error) {
	...
	copy(signer[:], crypto.Ripemd160Hash(crypto.Sha256Hash(crypto.PubkeyCompress(pubkey))))
...
// Version returns the current olink protocol version.
