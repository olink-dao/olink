...
import (
	...
	"github.com/olink/go-olink/p2p/simulations"
	"github.com/olink/go-olink/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	olink, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, olink, &config)
	if err != nil {
		return nil, err
	}
	return olink, nil
