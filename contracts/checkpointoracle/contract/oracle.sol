 ...
 * @author Gary Rong<garyrong@olink.org>, Martin Swende <martin.swende@olink.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the olink.
    uint sectionSize;
