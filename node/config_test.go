...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "olink.ipc", false, filepath.Join(os.TempDir(), "olink.ipc")},
		{"data", "olink.ipc", false, "data/olink.ipc"},
		{"data", "./olink.ipc", false, "./olink.ipc"},
		{"data", "/olink.ipc", false, "/olink.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "olink.ipc", true, `\\.\pipe\olink.ipc`},
		{"data", "olink.ipc", true, `\\.\pipe\olink.ipc`},
		{"data", `\\.\pipe\olink.ipc`, true, `\\.\pipe\olink.ipc`},
	}
