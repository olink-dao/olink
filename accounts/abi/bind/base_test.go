...
func (mc *mockCaller) CallContract(ctx context.Context, call olink.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call olink.CallMsg) ([]byte, error) {
