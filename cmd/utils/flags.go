// Copyright 2015 The go-olink Authors
// This file is part of go-olink.
//
// go-olink is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// go-olink is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with go-olink. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for go-olink commands.
package utils
...
import (
	...
	"github.com/olink/go-olink/accounts"
	"github.com/olink/go-olink/accounts/keystore"
	"github.com/olink/go-olink/common"
	"github.com/olink/go-olink/common/fdlimit"
	"github.com/olink/go-olink/consensus"
	"github.com/olink/go-olink/consensus/clique"
	"github.com/olink/go-olink/consensus/ethash"
	...
	"github.com/olink/go-olink/eth"
	"github.com/olink/go-olink/eth/downloader"
	"github.com/olink/go-olink/eth/gasprice"
	"github.com/olink/go-olink/ethdb"
	"github.com/olink/go-olink/ethstats"
	"github.com/olink/go-olink/graphql"
	"github.com/olink/go-olink/internal/ethapi"
	"github.com/olink/go-olink/internal/flags"
	"github.com/olink/go-olink/les"
	"github.com/olink/go-olink/log"
	"github.com/olink/go-olink/metrics"
	"github.com/olink/go-olink/metrics/exp"
	"github.com/olink/go-olink/metrics/influxdb"
	"github.com/olink/go-olink/miner"
	"github.com/olink/go-olink/node"
	"github.com/olink/go-olink/p2p"
	"github.com/olink/go-olink/p2p/discv5"
	"github.com/olink/go-olink/p2p/enode"
	"github.com/olink/go-olink/p2p/nat"
	"github.com/olink/go-olink/p2p/netutil"
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	for _, url := range urls {
		if url != "" {
			...
			if err != nil {
				log.Crit("Bootstrap URL invalid", "onode", url, "err", err)
				continue
			}
...
func setBootstrapNodesV5(ctx *cli.Context, cfg *p2p.Config) {
	...
	for _, url := range urls {
		if url != "" {
			...
			if err != nil {
				log.Error("Bootstrap URL invalid", "onode", url, "err", err)
				continue
			}
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `olink account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/olink/whisper")
	}
}
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "olink.", tagsMap)
		}
...
// new format.
//
// e.g. olink account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// olink --keystore /tmp/mykeystore --lightkdf account new
//
