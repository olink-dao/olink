...
// Tests the go-olink to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_olink.json")
	if err != nil {
...
// Tests the go-olink to Parity chainspec conversion for the Stureby testnet.
